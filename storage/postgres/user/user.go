...
func (ur *UserRepository) Save(user *models.User) error {
	_, err := ur.db.Exec(context.Background(), "INSERT INTO user (username, password, created_at, updated_at) VALUES ($1, $2, $3, $4)",
		user.Username, user.Password, user.Created_at, user.Updated_at)
	if err != nil {
...
func (ur *UserRepository) FindAll() ([]models.User, error) {
	rows, err := ur.db.Query(context.Background(), "SELECT id, username, created_at, updated_at")
	if err != nil {
